  ...
  return (
    <main className="space-y-4 p-4 text-[#111111]">
      <header className="border-b border-[#e5e7eb] pb-4">
        <h1 className="text-base font-bold">Tambah Manajer</h1>
      </header>
      <form action="/api/admin/managers/create" method="POST" className="grid max-w-2xl gap-3">
        ...
        <button type="submit" className="w-fit bg-[#111111] px-4 py-2 text-sm font-medium text-white">Simpan Manajer</button>
      </form>
